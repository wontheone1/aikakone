...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__9479__auto__,writer__9480__auto__,opt__9481__auto__){
return cljs.core._write(writer__9480__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28115 = o;
(G__28115[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__28116__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__28116 = function (var_args){
var args = null;
...
while (G__28117__i < G__28117__a.length) {G__28117__a[G__28117__i] = arguments[G__28117__i + 0]; ++G__28117__i;}
  args = new cljs.core.IndexedSeq(G__28117__a,0,null);
} 
return G__28116__delegate.call(this,args);};
G__28116.cljs$lang$maxFixedArity = 0;
G__28116.cljs$lang$applyTo = (function (arglist__28118){
var args = cljs.core.seq(arglist__28118);
return G__28116__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__28120){
...
var props = map__28121__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28121__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28123){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28124__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__28124,map__28124__$1,on_write){
return (function (){
...
});})(node_value,map__28124,map__28124__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__28129){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28130__$1,cljs.core.cst$kw$synthetic_DASH_on_DASH_update);
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28130__$1,cljs.core.cst$kw$synthetic_DASH_on_DASH_change);
if(cljs.core.truth_((function (){var and__8796__auto__ = !((jsprops == null));
if(and__8796__auto__){
var and__8796__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28132 = jsprops;
(G__28132["defaultValue"] = value);

(G__28132["onChange"] = ((function (G__28132,v,value,on_change,on_change__$1,map__28130,map__28130__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__28126_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__28126_SHARP_);
});})(G__28132,v,value,on_change,on_change__$1,map__28130,map__28130__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__28136 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28136,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28136,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28136,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___28140 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___28140 == null)){
} else {
var key_28141 = temp__5461__auto___28140;
(jsprops["key"] = key_28141);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__28144){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28145__$1,cljs.core.cst$kw$synthetic_DASH_input);
...
var wrapped = (function (){var G__28147 = reagent.impl.template.__GT_NativeWrapper();
(G__28147["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__28148 = wrapped;
(G__28148["syntheticInput"] = true);

return G__28148;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__28149 = wrapped__$1;
(G__28149["syntheticOnChange"] = on_change);

return G__28149;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__28150 = wrapped__$2;
(G__28150["syntheticOnUpdate"] = on_update);
...
if(cljs.core.truth_((function (){var or__8808__auto__ = synthetic_input;
...
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28152) : reagent.impl.template.as_element.call(null,G__28152));
} else {
...
var len__10087__auto___28157 = arguments.length;
var i__10088__auto___28158 = (0);
while(true){
if((i__10088__auto___28158 < len__10087__auto___28157)){
args__10094__auto__.push((arguments[i__10088__auto___28158]));

var G__28159 = (i__10088__auto___28158 + (1));
i__10088__auto___28158 = G__28159;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__10095__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28155){
var G__28156 = cljs.core.first(seq28155);
var seq28155__$1 = cljs.core.next(seq28155);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28156,seq28155__$1);
});
...
break;
default:
var G__28162 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__28162;
continue;
...
var n__9853__auto___28164 = a.length;
var i_28165 = (0);
while(true){
if((i_28165 < n__9853__auto___28164)){
(a[i_28165] = reagent.impl.template.as_element((a[i_28165])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__9853__auto___28167 = a.length;
var i_28168 = (0);
while(true){
if((i_28168 < n__9853__auto___28167)){
var val_28169 = (a[i_28168]);
if((cljs.core.vector_QMARK_(val_28169)) && ((reagent.impl.template.key_from_vec(val_28169) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28168] = reagent.impl.template.as_element(val_28169));

var G__28170 = (i_28168 + (1));
i_28168 = G__28170;
continue;
} else {
}
...
var ctx = ({});
var vec__28171 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28171,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28171,(1),null);
...
var G__28174 = (cljs.core.count(argv) - first_child);
switch (G__28174) {
case (0):
...
case (1):
var G__28175 = comp;
var G__28176 = jsprops;
var G__28177 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__28175,G__28176,G__28177) : reagent.impl.template.global$module$react.createElement.call(null,G__28175,G__28176,G__28177));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__28174){
