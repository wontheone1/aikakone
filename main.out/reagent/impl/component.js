...
if((i < len)){
var k = (ks[i]);
var G__28064 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__28065 = (i + (1));
m = G__28064;
i = G__28065;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__28066 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__28066) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__28066));
})());
} else {
var v = temp__5459__auto__;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__28068 = c;
var G__28068__$1 = (((G__28068 == null))?null:G__28068.prototype);
if((G__28068__$1 == null)){
return null;
} else {
return (G__28068__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__28070 = c;
var G__28070__$1 = (((G__28070 == null))?null:G__28070.prototype);
if((G__28070__$1 == null)){
return null;
} else {
return (G__28070__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__28074__delegate = function (args){
var G__28072 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__28072) : reagent.impl.component.as_element.call(null,G__28072));
};
...
return G__28074__delegate.call(this,args);};
G__28074.cljs$lang$maxFixedArity = 0;
G__28074.cljs$lang$applyTo = (function (arglist__28076){
var args = cljs.core.seq(arglist__28076);
return G__28074__delegate(args);
});
...
var _STAR_current_component_STAR_28078 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_28078;
}});
...
return ((function (G__28079,G__28079__$1){
...
var or__8808__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__8808__auto__){
...
var c = this;
var G__28080_28082 = (c["cljsRatom"]);
if((G__28080_28082 == null)){
} else {
reagent.ratom.dispose_BANG_(G__28080_28082);
}
...
if(cljs.core.truth_((function (){var and__8796__auto__ = wrap;
...
var renders_28084 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_28085 = cljs.core.first(cljs.core.vals(renders_28084));
if((cljs.core.count(renders_28084) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_28084))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_28085)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_28085], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__8808__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
} else {
...
var render_fun__$1 = (function (){var or__8808__auto__ = render_fun;
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8808__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
} else {
...
var name__$1 = (function (){var G__28083 = name;
switch (G__28083) {
case "":
...
var G__28088 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__28088) : reagent.impl.component.global$module$create_react_class.call(null,G__28088));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__28089 = fiber;
var G__28089__$1 = (((G__28089 == null))?null:(G__28089["type"]));
if((G__28089__$1 == null)){
return null;
} else {
return (G__28089__$1["displayName"]);
}
})();
var parent = (function (){var G__28090 = fiber;
if((G__28090 == null)){
return null;
} else {
return (G__28090["return"]);
}
})();
var path = (function (){var G__28091 = parent;
var G__28091__$1 = (((G__28091 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__28091) : reagent.impl.component.fiber_component_path.call(null,G__28091)));
if((G__28091__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28091__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var G__28092 = c;
if((G__28092 == null)){
return null;
} else {
return (G__28092["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__28093 = (function (){var or__8808__auto__ = (function (){var G__28095 = c;
if((G__28095 == null)){
return null;
} else {
return (G__28095["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
...
return (G__28093["_currentElement"]);
}
})();
var name = (function (){var G__28096 = elem;
var G__28096__$1 = (((G__28096 == null))?null:(G__28096["type"]));
if((G__28096__$1 == null)){
return null;
} else {
return (G__28096__$1["displayName"]);
}
})();
var path = (function (){var G__28097 = elem;
var G__28097__$1 = (((G__28097 == null))?null:(G__28097["_owner"]));
var G__28097__$2 = (((G__28097__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__28097__$1) : reagent.impl.component.component_path.call(null,G__28097__$1)));
if((G__28097__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28097__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__8808__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__8808__auto__)){
return or__8808__auto__;
} else {
var G__28098 = c;
var G__28098__$1 = (((G__28098 == null))?null:G__28098.constructor);
if((G__28098__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__28098__$1);
}
}
})();
