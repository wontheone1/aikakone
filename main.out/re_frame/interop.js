...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__28294 = cljs.core.instance_QMARK_;
var expr__28295 = reactive_val;
if(cljs.core.truth_((pred__28294.cljs$core$IFn$_invoke$arity$2 ? pred__28294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__28295) : pred__28294.call(null,reagent.ratom.RAtom,expr__28295)))){
return "ra";
} else {
if(cljs.core.truth_((pred__28294.cljs$core$IFn$_invoke$arity$2 ? pred__28294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__28295) : pred__28294.call(null,reagent.ratom.RCursor,expr__28295)))){
return "rc";
} else {
if(cljs.core.truth_((pred__28294.cljs$core$IFn$_invoke$arity$2 ? pred__28294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__28295) : pred__28294.call(null,reagent.ratom.Reaction,expr__28295)))){
return "rx";
} else {
if(cljs.core.truth_((pred__28294.cljs$core$IFn$_invoke$arity$2 ? pred__28294.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__28295) : pred__28294.call(null,reagent.ratom.Track,expr__28295)))){
return "tr";
} else {
return "other";
}
