...
leipzig.scale.floor = (function leipzig$scale$floor(p1__39635_SHARP_){
return Math.floor(p1__39635_SHARP_);
});
leipzig.scale.ceil = (function leipzig$scale$ceil(p1__39637_SHARP_){
return Math.ceil(p1__39637_SHARP_);
});
...
return (- (function (){var G__39638 = cljs.core.reverse(intervals);
var G__39639 = (- degree);
return (leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2 ? leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2(G__39638,G__39639) : leipzig.scale.scale_of.call(null,G__39638,G__39639));
})());
}));
leipzig.scale.scale_of.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$fraction,(function (intervals,degree){
var lower = (function (){var G__39640 = intervals;
var G__39641 = leipzig.scale.floor(degree);
return (leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2 ? leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2(G__39640,G__39641) : leipzig.scale.scale_of.call(null,G__39640,G__39641));
})();
var upper = (function (){var G__39642 = intervals;
var G__39643 = leipzig.scale.ceil(degree);
return (leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2 ? leipzig.scale.scale_of.cljs$core$IFn$_invoke$arity$2(G__39642,G__39643) : leipzig.scale.scale_of.call(null,G__39642,G__39643));
})();
...
return cljs.core.comp.cljs$core$IFn$_invoke$arity$3((function (p1__39644_SHARP_){
return (p1__39644_SHARP_ - (scale.cljs$core$IFn$_invoke$arity$1 ? scale.cljs$core$IFn$_invoke$arity$1(n) : scale.call(null,n)));
...
var fexpr__39645 = leipzig.scale.from((-12));
return (fexpr__39645.cljs$core$IFn$_invoke$arity$1 ? fexpr__39645.cljs$core$IFn$_invoke$arity$1(midi) : fexpr__39645.call(null,midi));
});
/**
...
var fexpr__39646 = leipzig.scale.from((12));
return (fexpr__39646.cljs$core$IFn$_invoke$arity$1 ? fexpr__39646.cljs$core$IFn$_invoke$arity$1(midi) : fexpr__39646.call(null,midi));
});
/**
 * Lower degree one octave (assuming a heptatonic scale).
 */
leipzig.scale.lower = (function leipzig$scale$lower(degree){
var fexpr__39647 = leipzig.scale.from((-7));
return (fexpr__39647.cljs$core$IFn$_invoke$arity$1 ? fexpr__39647.cljs$core$IFn$_invoke$arity$1(degree) : fexpr__39647.call(null,degree));
});
leipzig.scale.raise = (function leipzig$scale$raise(degree){

var fexpr__39648 = leipzig.scale.from((7));
return (fexpr__39648.cljs$core$IFn$_invoke$arity$1 ? fexpr__39648.cljs$core$IFn$_invoke$arity$1(degree) : fexpr__39648.call(null,degree));
});
