...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__9498__auto__,k36588,else__9499__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k36588,else__9499__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__36587){
var self__ = this;
var G__36587__$1 = this;
return (new cljs.core.RecordIter((0),G__36587__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__9264__auto____$1 = (function (){var fexpr__36593 = ((function (h__9264__auto__,this__9492__auto____$1){
...
;
return fexpr__36593(this__9492__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this36589,other36590){
var self__ = this;
var this36589__$1 = this;
return (!((other36590 == null))) && ((this36589__$1.constructor === other36590.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.status,other36590.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.body,other36590.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.status_text,other36590.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.headers,other36590.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.was_aborted,other36590.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this36589__$1.__extmap,other36590.__extmap));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__9503__auto__,k__9504__auto__,G__36587){
var self__ = this;
var this__9503__auto____$1 = this;
var pred__36594 = cljs.core.keyword_identical_QMARK_;
var expr__36595 = k__9504__auto__;
if(cljs.core.truth_((function (){var G__36597 = cljs.core.cst$kw$status;
var G__36598 = expr__36595;
return (pred__36594.cljs$core$IFn$_invoke$arity$2 ? pred__36594.cljs$core$IFn$_invoke$arity$2(G__36597,G__36598) : pred__36594.call(null,G__36597,G__36598));
})())){
return (new ajax.protocols.Response(G__36587,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36599 = cljs.core.cst$kw$body;
var G__36600 = expr__36595;
return (pred__36594.cljs$core$IFn$_invoke$arity$2 ? pred__36594.cljs$core$IFn$_invoke$arity$2(G__36599,G__36600) : pred__36594.call(null,G__36599,G__36600));
})())){
return (new ajax.protocols.Response(self__.status,G__36587,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36601 = cljs.core.cst$kw$status_DASH_text;
var G__36602 = expr__36595;
return (pred__36594.cljs$core$IFn$_invoke$arity$2 ? pred__36594.cljs$core$IFn$_invoke$arity$2(G__36601,G__36602) : pred__36594.call(null,G__36601,G__36602));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__36587,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36603 = cljs.core.cst$kw$headers;
var G__36604 = expr__36595;
return (pred__36594.cljs$core$IFn$_invoke$arity$2 ? pred__36594.cljs$core$IFn$_invoke$arity$2(G__36603,G__36604) : pred__36594.call(null,G__36603,G__36604));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__36587,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__36605 = cljs.core.cst$kw$was_DASH_aborted;
var G__36606 = expr__36595;
return (pred__36594.cljs$core$IFn$_invoke$arity$2 ? pred__36594.cljs$core$IFn$_invoke$arity$2(G__36605,G__36606) : pred__36594.call(null,G__36605,G__36606));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__36587,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__9504__auto__,G__36587),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__9495__auto__,G__36587){
var self__ = this;
var this__9495__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__36587,self__.__extmap,self__.__hash));
});
...
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__36591){
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__36591),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__36591),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__36591),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__36591),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__36591),null,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__36591,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0))),null));
});
