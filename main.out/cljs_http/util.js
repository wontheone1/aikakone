...
var vec__37904 = ((cljs.core.map_QMARK_(credentials))?cljs.core.map.cljs$core$IFn$_invoke$arity$2(credentials,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$username,cljs.core.cst$kw$password], null)):credentials);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37904,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37904,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__37907){
...
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37908__$1,cljs.core.cst$kw$scheme);
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37908__$1,cljs.core.cst$kw$server_DASH_name);
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37908__$1,cljs.core.cst$kw$server_DASH_port);
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37908__$1,cljs.core.cst$kw$uri);
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37908__$1,cljs.core.cst$kw$query_DASH_string);
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__37910 = (new goog.Uri());
G__37910.setScheme(cljs.core.name((function (){var or__8808__auto__ = scheme;
...
G__37910.setDomain(server_name);

G__37910.setPort(server_port);

G__37910.setPath(uri);

G__37910.setQuery(query_string,true);
...
var G__37911 = cljs.core.clj__GT_js(x);
return JSON.stringify(G__37911);
});
cljs_http.util.parse_headers = (function cljs_http$util$parse_headers(headers){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37913_SHARP_,p2__37912_SHARP_){
var vec__37914 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__37912_SHARP_,/:\s+/);
...
return p1__37913_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__37913_SHARP_,clojure.string.lower_case(k),v);
}
