...
var digit_29460 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_29461__$1 = (vlq >>> (5));
while(true){
if((vlq_29461__$1 > (0))){
var digit_29462__$1 = (digit_29460 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_29462__$1));

var G__29463 = (vlq_29461__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__29464 = (vlq_29461__$1 >>> (5));
digit_29460 = G__29463;
vlq_29461__$1 = G__29464;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_29460));
}
break;
}
...
var G__29465 = i__$1;
var G__29466 = result__$1;
var G__29467 = shift__$1;
i = G__29465;
result = G__29466;
shift = G__29467;
continue;
